...
import { erroresFirebase } from "../utils/erroresfirabase.js"; // Importa una función de utilidad para manejar errores relacionados con Firebase.
import { formValidates } from "../utils/FormValidates.js"; // Importa funciones de validación para el formulario.
    ...
    <>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        >
          ...
          {/* Muestra errores relacionados con el campo de email. */}
        </FormInput>
        ...
        >
          ...
          {/* Muestra errores relacionados con el campo de contraseña. */}
        </FormInput>
        ...
        >
          ...
          {/* Muestra errores relacionados con el campo de confirmación de contraseña. */}
        </FormInput>
